      ...
      <div class="flex flex-wrap">
          ...
          <div class="relative h-full overflow-hidden">
            <div class="absolute z-10 bottom-7 left-7 rounded-full">
              <a class="group flex flex-wrap items-center -m-1" href="#">
                ...
                <div class="w-auto p-1">
                  <h3 class="font-semibold text-3xl w-40 group-hover:underline text-white" style={{letterSpacing : '-0.5px'}}>Watch this How to video</h3>
                </div>
              </a>
            </div>
            <img class="w-full h-full object-cover transform hover:scale-105 transition duration-500" src="https://images.pexels.com/photos/977003/pexels-photo-977003.jpeg?auto=compress&cs=tinysrgb&w=600" alt="" />
          </div>
        </div>
        <div class="flex-1 md:w-1/2">
          <div class="p-10 flex flex-col justify-between h-full bg-black">
            ...
            <div>
              <h3 class="mb-3 text-3xl font-semibold text-white" style={{letterSpacing : '-0.5px'}}>Start with a free trial - no credit card required.</h3>
